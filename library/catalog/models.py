...
class Author(models.Model):
    ...
    date_birth = models.DateField(max_length=100, verbose_name='Дата рождения', blank=False, null=False)

    def __str__(self):
        return '{} {} {}'.format(self.last_name, self.first_name, self.patronymic,)

    class Meta:
        unique_together = ('last_name', 'first_name', 'patronymic', 'date_birth')
        verbose_name = 'Автор'
...
class Book(models.Model):
    ...
    year_release = models.IntegerField(verbose_name='Год выпуска', blank=False,
